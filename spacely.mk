...
$(IntermediateDirectory)/src_CollapseManager.cpp$(ObjectSuffix): src/CollapseManager.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_CollapseManager.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_CollapseManager.cpp$(DependSuffix) -MM src/CollapseManager.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/alecca/Documents/spacely/src/CollapseManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_CollapseManager.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_CollapseManager.cpp$(PreprocessSuffix): src/CollapseManager.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_CollapseManager.cpp$(PreprocessSuffix) src/CollapseManager.cpp
