...
/feature-dev:feature-dev Add a text object type, with colors, size, style (bold italic) and fonts, ability to size them in a box (layout) or artistic (size whole text).
